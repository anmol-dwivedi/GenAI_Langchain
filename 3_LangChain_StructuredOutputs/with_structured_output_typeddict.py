...
class Review(TypedDict):
    key_themes : Annotated[list, "Write down all the key themese discussed in the review in a list"]
...
# instead of invoking the model, we will invoke the structured output
